...
def load_graph_by_name(graph_name: str) -> MultiDiGraph:
...
def create_two_cycled_graph(fst_c_node_num: int, snd_c_node_num: int, labels: Tuple[str, str]) -> MultiDiGraph:
...
#g = create_two_cycled_graph(4, 5, ("pipi", "pupu"))
#save_graph_to_dot(g, "hi.dot")
